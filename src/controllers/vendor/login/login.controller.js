...
const login = asyncHandler (async (req, res) => {
    ...
    try {
        ...
        if (!user.verified) throw new ApiError(statusCodeObject.HTTP_STATUS_BAD_REQUEST, errorAndSuccessCodeConfiguration.HTTP_STATUS_BAD_REQUEST, loginMessage.ACCOUNT_VERIFICATION_PENDING);
