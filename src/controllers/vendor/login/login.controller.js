...
const login = asyncHandler (async (req, res) => {
    ...
    try {
        ...
        if (user.isDocumentUploaded && (user.verified.toLowerCase() !== "approved")) throw new ApiError(statusCodeObject.HTTP_STATUS_BAD_REQUEST, errorAndSuccessCodeConfiguration.HTTP_STATUS_BAD_REQUEST, `${loginMessage.ACCOUNT_VERIFICATION_PENDING}${user.verified}`);
