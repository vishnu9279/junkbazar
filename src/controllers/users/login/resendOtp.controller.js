...
const resendOtp = asyncHandler (async (req, res) => {
    console.log("resendOtp working", req.body);
    let OTP, session;
    ...
    try {
        ...
        if ( fieldValidator(phoneNumber)) throw new ApiError(statusCodeObject.HTTP_STATUS_BAD_REQUEST, errorAndSuccessCodeConfiguration.HTTP_STATUS_BAD_REQUEST, CommonMessage.ERROR_FIELD_REQUIRED);
