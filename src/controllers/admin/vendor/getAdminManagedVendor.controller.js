...
const getAdminManagedVendor = asyncHandler(async (req, res) => {
    console.log("getAdminManagedVendor working");
    ...
    try {
        ...
        if (error instanceof ApiError) {
            ...
            console.error("Error in getAdminManagedVendor:", error);
...
export default getAdminManagedVendor;
