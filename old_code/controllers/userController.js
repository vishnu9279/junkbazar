...
exports.resendOTP = async (req, res) => {
    try {
        ...
        res.status(200).json({
            message: "The otp as been send to your phone number: " + otp 
        });
    }
    catch (error) {
        res.status(500).json({
...
exports.forgetPassword = async (req, res) => {
    try {
        ...
        res.status(200).json({
            data: user._id,
            message: "An OTP have been sent to Your Phone OTP: " + otp 
        });
    }
    catch (error) {
        res.status(500).json({
...
exports.verify_reset_password_otp = async (req, res) => {
    try {
        ...
        res
            .status(200)
            .json({
                message: "User verified, You can change your password" 
            });
    ...
    try {
        ...
        if ((user.OTP = "")) {
            res
                .status(403)
                .json({
                    message: "You'er not Authorize to perform this action" 
                });
        }
...
exports.userDocuments = async (req, res) => {
    try {
        ...
        await UserModel.findByIdAndUpdate(user._id, updateObject, {
            new: true 
        });

        res.status(200).json({
            message: "Documents as been Uploaded" 
        });
